...
#exclude selected sample from the plot
```{r}
# Load necessary libraries
library("ggplot2")
library("DESeq2")
...
# Plot PCA by column variable and save as a PNG file
png(filename = "PCA_plot_3.png", width = 10, height = 10, units = "in", res = 600)
...
# Exclude the specified sample
pcaData <- pcaData[pcaData$sample != "JvRad_Rhipp_204", ]
